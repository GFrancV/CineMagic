...
@section('content')
    <a href="/admin/acesso/" class="btn btn-secondary">
        <--- Voltar</a>
            <br>
            <br>
            @if ($status == 'error')
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link {{ app('request')->input('type') == 'id' ? 'active' : '' }}"
                                href="?type=id">ID
                                Bilhete</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ app('request')->input('type') == 'qr' ? 'active' : '' }}"
                                href="?type=qr">QR
                                Code</a>
                        </li>
                    </ul>
                        ...
                        <div class="bilhete">
                            ...
                            <form action="{{ route('admin.acesso.acept', ['bilhete' => $infoBilhete]) }}" method="POST">
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <a href="{{ '/admin/acesso/' . $sessionId . '?type=id' }}"
